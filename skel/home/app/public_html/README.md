...
To customize the default welcome page, just edit [index.html](index.html), or delete both of these files or start over. **Just do not change the name or location of this directory!!!**
